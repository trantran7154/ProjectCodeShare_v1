...
namespace CodeShare.Frontend.Areas.Admin.Controllers
{
    public class UsersAdminController : Controller
    {
        ...
        {
            return View(db.Users.Where(n => n.user_del == false).ToList());
        }

        // Create
        //public ActionResult CreateUser(User users, HttpPostedFileBase IMG)
        //{
