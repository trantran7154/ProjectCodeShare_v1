...
namespace CodeShare.Frontend.Areas.Admin.Controllers
{
    public class BannersAdminController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "banner_id,banner_title,banner_image,banner_link,banner_datecreate,banner_active")] Banner banner)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "banner_id,banner_title,banner_image,banner_link,banner_datecreate,banner_active")] Banner banner)
        {
            if (ModelState.IsValid)
            {
